...
photologo = 'https://i.ibb.co/Swd0WDW9/photo-2025-05-09-20-09-39-7502540716233457668.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://i.ibb.co/hxQ73ZYw/photo-2025-04-12-18-46-28-7492500010408345604.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://i.ibb.co/1YjMPGgZ/photo-2025-04-12-18-52-23-7492501513646899244.jpg'
...
async def restart_handler(_, m):
    await m.reply_text("**chal ht ja rhe thuje chor kr **", True)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────🎉✨️🎊🎀────────╮\n"   
        f"🙆‍♂️ 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 [🤷‍♂️『 WELCOME STRANGER 』🙋](https://t.me/Strangerboy27_bot_strangerboy) 🎉\n"
        f"╰────────🎉✨️🎊🎀────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):  
    if m.chat.id not in AUTH_USERS and m.chat.id not in CHANNELS_LIST:
        ...
        return
    editable = await m.reply_text(f"**🙇 Hi I am Poweful  [STRANGER](https://i.ibb.co/DgRpQhw6/photo-2025-04-30-11-42-22-7499070258104238100.jpg) TXT Downloader📥 Bot.\n🔹Send me the txt file and wait.**")
    ...
    if raw_text3 == '1':
        CR = '[समय यात्री](https://t.me/Strangerboy27_bot_strangerboy)'
    else:
        CR = raw_text3
    ...
    if input6.photo:
        ...
        thumb = raw_text6
    await editable.delete()
    await m.reply_text(f"__**👨‍⚖️Target Batch  [समय यात्री](https://i.ibb.co/Swd0WDW9/photo-2025-05-09-20-09-39-7502540716233457668.jpg): {b_name}**__")
